...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_adv_only', type=lambda x: bool(strtobool(x)), default=False, help='Use only adversarial training (no noise injection)')
    parser.add_argument('--use_noise_only', type=lambda x: bool(strtobool(x)), default=False, help='Use only noise injection (no adversarial training)')
